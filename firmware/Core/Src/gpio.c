...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_BACKLIGHT_Pin|COLOR_S3_Pin|COLOR_S2_Pin|US_TRIG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ENC1_B_Pin ENC2_B_Pin BUTTON_Pin */
  GPIO_InitStruct.Pin = ENC1_B_Pin|ENC2_B_Pin|BUTTON_Pin;
  ...
  /*Configure GPIO pins : LCD_BACKLIGHT_Pin COLOR_S3_Pin COLOR_S2_Pin US_TRIG_Pin */
  GPIO_InitStruct.Pin = LCD_BACKLIGHT_Pin|COLOR_S3_Pin|COLOR_S2_Pin|US_TRIG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
